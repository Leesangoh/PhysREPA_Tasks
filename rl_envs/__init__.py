...
gym.register(
    id="PhysREPA-Strike-Franka-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": "physrepa_tasks.rl_envs.strike_rl_cfg:StrikeRLEnvCfg",
        "rsl_rl_cfg_entry_point": "physrepa_tasks.rl_envs.agents.rsl_rl_strike_cfg:StrikePPORunnerCfg",
    },
    disable_env_checker=True,
)

gym.register(
    id="PhysREPA-Strike-Franka-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": "physrepa_tasks.rl_envs.strike_rl_cfg:StrikeRLEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": "physrepa_tasks.rl_envs.agents.rsl_rl_strike_cfg:StrikePPORunnerCfg",
    },
    disable_env_checker=True,
)
