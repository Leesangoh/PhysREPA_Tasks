...
|---|---:|---:|---:|---:|---:|---:|---|
| ee_direction_3d | 3 | 0.5921 | 0.7179 | 0.7296 | 22 | 0.7263 | intermediate |
| ee_speed | 1 | 0.8130 | 0.9112 | 0.9161 | 9 | 0.9106 | always-linear |
...
- feature_root: `/mnt/md1/solee/features/physprobe_vitl_tokenpatch_shuffled_seed42/push`
- feature_type: `token_patch`
- run_tag: `f5_shuffle42_seed123`
- n_episodes: `1500`
- num_layers: `24`
