...
|---|---:|---:|---:|---:|---:|---:|---|
| ee_direction_3d | 3 | 0.5842 | 0.7144 | 0.7389 | 22 | 0.7369 | intermediate |
| ee_speed | 1 | 0.8001 | 0.9105 | 0.9134 | 11 | 0.9022 | always-linear |
...
- feature_root: `/mnt/md1/solee/features/physprobe_vitl_tokenpatch_shuffled_seed123/push`
- feature_type: `token_patch`
- run_tag: `f5_shuffle123_seed42`
- n_episodes: `1500`
- num_layers: `24`
